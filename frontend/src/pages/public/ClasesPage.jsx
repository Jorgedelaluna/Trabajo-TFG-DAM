      ...
      ====================================================== */}
            <div className="container text-center mb-5">
                ...
                <p className="text-light opacity-75">
                    Entrena con nosotros y descubre el verdadero esp韗itu del CrossFit.
                </p>
            </div>
                    ...
                    <div className="col-md-4">
                        <div className="card clases-card h-100 shadow">
                            ...
                            <div className="card-body">
                                ...
                                <p>
                                    Perfecciona la t閏nica de los levantamientos ol韒picos: snatch y clean & jerk.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className="card clases-card h-100 shadow">
                            ...
                            <div className="card-body">
                                ...
                                <p>
                                    Mejora tus habilidades gimn醩ticas: dominadas, handstands y muscle-ups.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className="card clases-card h-100 shadow">
                            <img
                                ...
                                className="card-img-top"
                                alt="Meditaci贸n & Mobility"
                            />
                            <div className="card-body">
                                <h3 className="fw-bold">Meditaci贸n & Mobility</h3>
                                <p>
                    ...
                    <div className="col-md-4">
                        <div className="card clases-card h-100 shadow">
                            ...
                            <div className="card-body">
                                ...
                                <p>
                                    Espacio libre para entrenar por tu cuenta o practicar t茅cnica.
                                </p>
                            </div>
                        </div>
                    </div>

...
Desarrollar una aplicación de gestión para un gimnasio de CrossFit que facilite las operaciones administrativas, mejora la experiencia del usuario y optimice el control de actividades.
